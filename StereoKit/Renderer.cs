...
namespace StereoKit
{
    public class Renderer
    {
        ...
        [DllImport(NativeLib.DllName, CallingConvention = CallingConvention.Cdecl)]
        static extern void render_add_mesh_atm(IntPtr mesh, IntPtr material, in Matrix matrix);
        [DllImport(NativeLib.DllName, CallingConvention = CallingConvention.Cdecl)]
        ...
        public static void Add(Mesh mesh, Material material, in Matrix transform)
        {
            render_add_mesh_atm(mesh._meshInst, material._materialInst, in transform);
        }
