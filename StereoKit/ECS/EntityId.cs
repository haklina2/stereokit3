...
namespace StereoKit
{
    /// <summary> An EntityId is a smart index to an Entity struct. Since you cannot
    ...
    /// the Entity struct in the system's array! </summary>
    public struct EntityId
    {
        /// <summary> Index in the entity array found in ECSManager.</summary>
        internal int    index;
        /// <summary> Since empty slots in the entity array will be re-used, this Id 
        /// distinguishes this Id from that of an old, deleted Entity with a 
        /// different slot Id. </summary>
        internal ushort slotId;

        /// <summary> Adds a component to the Entity, and returns a smart Id to the new 
        /// component. A Start event will be queued up for the component before
        ...
        /// <summary> Searches for the first instance of a 'T' component associated with this
        /// Entity, and returns a smart index to it. If no component is found, then
